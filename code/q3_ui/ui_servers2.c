...
static void ArenaServers_UpdatePicture( void ) {
	...
	if( !g_arenaservers.list.numitems ) {
		g_arenaservers.mappic.generic_mc.name = NULL;
	}
	else {
		...
		g_arenaservers.mappic.generic_mc.name = picname;
...
static void ArenaServers_UpdateMenu( void ) {
	...
	if( g_arenaservers.numqueriedservers > 0 ) {
		...
		if( g_arenaservers.refreshservers && ( g_arenaservers.currentping <= g_arenaservers.numqueriedservers ) ) {
			...
			g_arenaservers.master.generic_mc.flags		&= ~QMF_GRAYED;
			g_arenaservers.gametype.generic_mc.flags	&= ~QMF_GRAYED;
			g_arenaservers.sortkey.generic_mc.flags	&= ~QMF_GRAYED;
			g_arenaservers.showempty.generic_mc.flags	&= ~QMF_GRAYED;
			g_arenaservers.showfull.generic_mc.flags	&= ~QMF_GRAYED;
			g_arenaservers.list.generic_mc.flags		&= ~QMF_GRAYED;
			g_arenaservers.refresh.generic_mc.flags	&= ~QMF_GRAYED;
			g_arenaservers.go.generic_mc.flags			&= ~QMF_GRAYED;
			g_arenaservers.punkbuster.generic_mc.flags &= ~QMF_GRAYED;
...
static void ArenaServers_Insert( char* adrstr, char* info, int pingtime )
{
	...
	servernodeptr->bPB = (qboolean)atoi( Info_ValueForKey( info, "punkbuster") ); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
...
void ArenaServers_SetType( int type )
{
	...
	default:
	case AS_LOCAL:
		g_arenaservers.remove.generic_mc.flags |= (QMF_INACTIVE|QMF_HIDDEN);
...
static void ArenaServers_MenuInit( void ) {
	...
	g_arenaservers.banner.generic_mc.type  = MTYPE_BTEXT;
	g_arenaservers.banner.generic_mc.flags = QMF_CENTER_JUSTIFY;
	g_arenaservers.banner.generic_mc.x	    = 320;
	g_arenaservers.banner.generic_mc.y	    = 16;
	g_arenaservers.banner.string  		= "ARENA SERVERS";
	g_arenaservers.banner.style  	    = UI_CENTER;
	g_arenaservers.banner.color  	    = color_white;

	y = 80;
	g_arenaservers.master.generic_mc.type			= MTYPE_SPINCONTROL;
	g_arenaservers.master.generic_mc.name			= "Servers:";
	g_arenaservers.master.generic_mc.flags			= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.master.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.master.generic_mc.id			= ID_MASTER;
	g_arenaservers.master.generic_mc.x				= 320;
	g_arenaservers.master.generic_mc.y				= y;
	g_arenaservers.master.itemnames				= master_items;

	y += SMALLCHAR_HEIGHT;
	g_arenaservers.gametype.generic_mc.type		= MTYPE_SPINCONTROL;
	g_arenaservers.gametype.generic_mc.name		= "Game Type:";
	g_arenaservers.gametype.generic_mc.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.gametype.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.gametype.generic_mc.id			= ID_GAMETYPE;
	g_arenaservers.gametype.generic_mc.x			= 320;
	g_arenaservers.gametype.generic_mc.y			= y;
	g_arenaservers.gametype.itemnames			= servertype_items;

	y += SMALLCHAR_HEIGHT;
	g_arenaservers.sortkey.generic_mc.type			= MTYPE_SPINCONTROL;
	g_arenaservers.sortkey.generic_mc.name			= "Sort By:";
	g_arenaservers.sortkey.generic_mc.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.sortkey.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.sortkey.generic_mc.id			= ID_SORTKEY;
	g_arenaservers.sortkey.generic_mc.x			= 320;
	g_arenaservers.sortkey.generic_mc.y			= y;
	g_arenaservers.sortkey.itemnames			= sortkey_items;

	y += SMALLCHAR_HEIGHT;
	g_arenaservers.showfull.generic_mc.type		= MTYPE_RADIOBUTTON;
	g_arenaservers.showfull.generic_mc.name		= "Show Full:";
	g_arenaservers.showfull.generic_mc.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.showfull.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.showfull.generic_mc.id			= ID_SHOW_FULL;
	g_arenaservers.showfull.generic_mc.x			= 320;
	g_arenaservers.showfull.generic_mc.y			= y;

	y += SMALLCHAR_HEIGHT;
	g_arenaservers.showempty.generic_mc.type		= MTYPE_RADIOBUTTON;
	g_arenaservers.showempty.generic_mc.name		= "Show Empty:";
	g_arenaservers.showempty.generic_mc.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.showempty.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.showempty.generic_mc.id			= ID_SHOW_EMPTY;
	g_arenaservers.showempty.generic_mc.x			= 320;
	g_arenaservers.showempty.generic_mc.y			= y;

	y += 3 * SMALLCHAR_HEIGHT;
	g_arenaservers.list.generic_mc.type			= MTYPE_SCROLLLIST;
	g_arenaservers.list.generic_mc.flags			= QMF_HIGHLIGHT_IF_FOCUS;
	g_arenaservers.list.generic_mc.id				= ID_LIST;
	g_arenaservers.list.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.list.generic_mc.x				= 72;
	g_arenaservers.list.generic_mc.y				= y;
	...
	g_arenaservers.mappic.generic_mc.type			= MTYPE_BITMAP;
	g_arenaservers.mappic.generic_mc.flags			= QMF_LEFT_JUSTIFY|QMF_INACTIVE;
	g_arenaservers.mappic.generic_mc.x				= 72;
	g_arenaservers.mappic.generic_mc.y				= 80;
	g_arenaservers.mappic.width					= 128;
	g_arenaservers.mappic.height				= 96;
	g_arenaservers.mappic.errorpic				= ART_UNKNOWNMAP;

	g_arenaservers.arrows.generic_mc.type			= MTYPE_BITMAP;
	g_arenaservers.arrows.generic_mc.name			= ART_ARROWS0;
	g_arenaservers.arrows.generic_mc.flags			= QMF_LEFT_JUSTIFY|QMF_INACTIVE;
	g_arenaservers.arrows.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.arrows.generic_mc.x				= 512+48;
	g_arenaservers.arrows.generic_mc.y				= 240-64+16;
	g_arenaservers.arrows.width					= 64;
	g_arenaservers.arrows.height				= 128;

	g_arenaservers.up.generic_mc.type				= MTYPE_BITMAP;
	g_arenaservers.up.generic_mc.flags				= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_MOUSEONLY;
	g_arenaservers.up.generic_mc.callback			= ArenaServers_Event;
	g_arenaservers.up.generic_mc.id				= ID_SCROLL_UP;
	g_arenaservers.up.generic_mc.x					= 512+48;
	g_arenaservers.up.generic_mc.y					= 240-64+16;
	g_arenaservers.up.width						= 64;
	g_arenaservers.up.height					= 64;
	g_arenaservers.up.focuspic					= ART_ARROWS_UP;

	g_arenaservers.down.generic_mc.type			= MTYPE_BITMAP;
	g_arenaservers.down.generic_mc.flags			= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_MOUSEONLY;
	g_arenaservers.down.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.down.generic_mc.id				= ID_SCROLL_DOWN;
	g_arenaservers.down.generic_mc.x				= 512+48;
	g_arenaservers.down.generic_mc.y				= 240+16;
	g_arenaservers.down.width					= 64;
	g_arenaservers.down.height					= 64;
	g_arenaservers.down.focuspic				= ART_ARROWS_DOWN;

	y = 376;
	g_arenaservers.status.generic_mc.type		= MTYPE_TEXT;
	g_arenaservers.status.generic_mc.x			= 320;
	g_arenaservers.status.generic_mc.y			= y;
	...
	y += SMALLCHAR_HEIGHT;
	g_arenaservers.statusbar.generic_mc.type   = MTYPE_TEXT;
	g_arenaservers.statusbar.generic_mc.x	    = 320;
	g_arenaservers.statusbar.generic_mc.y	    = y;
	g_arenaservers.statusbar.string	        = "";
	g_arenaservers.statusbar.style	        = UI_CENTER|UI_SMALLFONT;
	g_arenaservers.statusbar.color	        = text_color_normal;

	g_arenaservers.remove.generic_mc.type		= MTYPE_BITMAP;
	g_arenaservers.remove.generic_mc.name		= ART_REMOVE0;
	g_arenaservers.remove.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.remove.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.remove.generic_mc.id		= ID_REMOVE;
	g_arenaservers.remove.generic_mc.x			= 450;
	g_arenaservers.remove.generic_mc.y			= 86;
	g_arenaservers.remove.width				= 96;
	g_arenaservers.remove.height			= 48;
	g_arenaservers.remove.focuspic			= ART_REMOVE1;

	g_arenaservers.back.generic_mc.type		= MTYPE_BITMAP;
	g_arenaservers.back.generic_mc.name		= ART_BACK0;
	g_arenaservers.back.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.back.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.back.generic_mc.id			= ID_BACK;
	g_arenaservers.back.generic_mc.x			= 0;
	g_arenaservers.back.generic_mc.y			= 480-64;
	g_arenaservers.back.width				= 128;
	g_arenaservers.back.height				= 64;
	g_arenaservers.back.focuspic			= ART_BACK1;

	g_arenaservers.specify.generic_mc.type	    = MTYPE_BITMAP;
	g_arenaservers.specify.generic_mc.name		= ART_SPECIFY0;
	g_arenaservers.specify.generic_mc.flags    = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.specify.generic_mc.callback = ArenaServers_Event;
	g_arenaservers.specify.generic_mc.id	    = ID_SPECIFY;
	g_arenaservers.specify.generic_mc.x		= 128;
	g_arenaservers.specify.generic_mc.y		= 480-64;
	g_arenaservers.specify.width  		    = 128;
	g_arenaservers.specify.height  		    = 64;
	g_arenaservers.specify.focuspic         = ART_SPECIFY1;

	g_arenaservers.refresh.generic_mc.type		= MTYPE_BITMAP;
	g_arenaservers.refresh.generic_mc.name		= ART_REFRESH0;
	g_arenaservers.refresh.generic_mc.flags	= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.refresh.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.refresh.generic_mc.id		= ID_REFRESH;
	g_arenaservers.refresh.generic_mc.x		= 256;
	g_arenaservers.refresh.generic_mc.y		= 480-64;
	g_arenaservers.refresh.width			= 128;
	g_arenaservers.refresh.height			= 64;
	g_arenaservers.refresh.focuspic			= ART_REFRESH1;

	g_arenaservers.create.generic_mc.type		= MTYPE_BITMAP;
	g_arenaservers.create.generic_mc.name		= ART_CREATE0;
	g_arenaservers.create.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.create.generic_mc.callback	= ArenaServers_Event;
	g_arenaservers.create.generic_mc.id		= ID_CREATE;
	g_arenaservers.create.generic_mc.x			= 384;
	g_arenaservers.create.generic_mc.y			= 480-64;
	g_arenaservers.create.width				= 128;
	g_arenaservers.create.height			= 64;
	g_arenaservers.create.focuspic			= ART_CREATE1;

	g_arenaservers.go.generic_mc.type			= MTYPE_BITMAP;
	g_arenaservers.go.generic_mc.name			= ART_CONNECT0;
	g_arenaservers.go.generic_mc.flags			= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	g_arenaservers.go.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.go.generic_mc.id			= ID_CONNECT;
	g_arenaservers.go.generic_mc.x				= 640;
	g_arenaservers.go.generic_mc.y				= 480-64;
	g_arenaservers.go.width					= 128;
	g_arenaservers.go.height				= 64;
	g_arenaservers.go.focuspic				= ART_CONNECT1;

	g_arenaservers.punkbuster.generic_mc.type			= MTYPE_SPINCONTROL;
	g_arenaservers.punkbuster.generic_mc.name			= "Punkbuster:";
	g_arenaservers.punkbuster.generic_mc.flags			= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	g_arenaservers.punkbuster.generic_mc.callback		= ArenaServers_Event;
	g_arenaservers.punkbuster.generic_mc.id			= ID_PUNKBUSTER;
	g_arenaservers.punkbuster.generic_mc.x				= 480+32;
	g_arenaservers.punkbuster.generic_mc.y				= 144;
	g_arenaservers.punkbuster.itemnames				= punkbuster_items;
	
	g_arenaservers.pblogo.generic_mc.type			= MTYPE_BITMAP;
	g_arenaservers.pblogo.generic_mc.name			= ART_PUNKBUSTER;
	g_arenaservers.pblogo.generic_mc.flags			= QMF_LEFT_JUSTIFY|QMF_INACTIVE;
	g_arenaservers.pblogo.generic_mc.x				= 526;
	g_arenaservers.pblogo.generic_mc.y				= 176;
