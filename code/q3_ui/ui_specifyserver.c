...
void SpecifyServer_MenuInit( void )
{
	...
	s_specifyserver.banner.generic_mc.type	 = MTYPE_BTEXT;
	s_specifyserver.banner.generic_mc.x     = 320;
	s_specifyserver.banner.generic_mc.y     = 16;
	...
	s_specifyserver.framel.generic_mc.type  = MTYPE_BITMAP;
	s_specifyserver.framel.generic_mc.name  = SPECIFYSERVER_FRAMEL;
	s_specifyserver.framel.generic_mc.flags = QMF_INACTIVE;
	s_specifyserver.framel.generic_mc.x	 = 0;  
	s_specifyserver.framel.generic_mc.y	 = 78;
	s_specifyserver.framel.width  	     = 256;
	s_specifyserver.framel.height  	     = 329;

	s_specifyserver.framer.generic_mc.type  = MTYPE_BITMAP;
	s_specifyserver.framer.generic_mc.name  = SPECIFYSERVER_FRAMER;
	s_specifyserver.framer.generic_mc.flags = QMF_INACTIVE;
	s_specifyserver.framer.generic_mc.x	 = 376;
	s_specifyserver.framer.generic_mc.y	 = 76;
	s_specifyserver.framer.width  	     = 256;
	s_specifyserver.framer.height  	     = 334;

	s_specifyserver.domain.generic_mc.type       = MTYPE_FIELD;
	s_specifyserver.domain.generic_mc.name       = "Address:";
	s_specifyserver.domain.generic_mc.flags      = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_specifyserver.domain.generic_mc.x	      = 206;
	s_specifyserver.domain.generic_mc.y	      = 220;
	s_specifyserver.domain.field.widthInChars = 38;
	s_specifyserver.domain.field.maxchars     = 80;

	s_specifyserver.port.generic_mc.type       = MTYPE_FIELD;
	s_specifyserver.port.generic_mc.name	    = "Port:";
	s_specifyserver.port.generic_mc.flags	    = QMF_PULSEIFFOCUS|QMF_SMALLFONT|QMF_NUMBERSONLY;
	s_specifyserver.port.generic_mc.x	        = 206;
	s_specifyserver.port.generic_mc.y	        = 250;
	s_specifyserver.port.field.widthInChars = 6;
	s_specifyserver.port.field.maxchars     = 5;

	s_specifyserver.go.generic_mc.type	    = MTYPE_BITMAP;
	s_specifyserver.go.generic_mc.name     = SPECIFYSERVER_FIGHT0;
	s_specifyserver.go.generic_mc.flags    = QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_specifyserver.go.generic_mc.callback = SpecifyServer_Event;
	s_specifyserver.go.generic_mc.id	    = ID_SPECIFYSERVERGO;
	s_specifyserver.go.generic_mc.x		= 640;
	s_specifyserver.go.generic_mc.y		= 480-64;
	s_specifyserver.go.width  		    = 128;
	s_specifyserver.go.height  		    = 64;
	s_specifyserver.go.focuspic         = SPECIFYSERVER_FIGHT1;

	s_specifyserver.back.generic_mc.type	  = MTYPE_BITMAP;
	s_specifyserver.back.generic_mc.name     = SPECIFYSERVER_BACK0;
	s_specifyserver.back.generic_mc.flags    = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_specifyserver.back.generic_mc.callback = SpecifyServer_Event;
	s_specifyserver.back.generic_mc.id	      = ID_SPECIFYSERVERBACK;
	s_specifyserver.back.generic_mc.x		  = 0;
	s_specifyserver.back.generic_mc.y		  = 480-64;
