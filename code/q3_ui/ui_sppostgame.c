...
static void UI_SPPostgameMenu_MenuDraw( void ) {
	...
	if( postgameMenuInfo.phase == 3 ) {
		...
		postgameMenuInfo.item_again.generic_mc.flags &= ~QMF_INACTIVE;
		postgameMenuInfo.item_next.generic_mc.flags &= ~QMF_INACTIVE;
		postgameMenuInfo.item_menu.generic_mc.flags &= ~QMF_INACTIVE;
...
void UI_SPPostgameMenu_Cache( void ) {
	...
	buildscript = (qboolean)((int)trap_Cvar_VariableValue("com_buildscript")); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
...
static void UI_SPPostgameMenu_Init( void ) {
	...
	postgameMenuInfo.item_menu.generic_mc.type			= MTYPE_BITMAP;
	postgameMenuInfo.item_menu.generic_mc.name			= ART_MENU0;
	postgameMenuInfo.item_menu.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	postgameMenuInfo.item_menu.generic_mc.x			= 0;
	postgameMenuInfo.item_menu.generic_mc.y			= 480-64;
	postgameMenuInfo.item_menu.generic_mc.callback		= UI_SPPostgameMenu_MenuEvent;
	postgameMenuInfo.item_menu.generic_mc.id			= ID_MENU;
	postgameMenuInfo.item_menu.width				= 128;
	postgameMenuInfo.item_menu.height				= 64;
	postgameMenuInfo.item_menu.focuspic				= ART_MENU1;

	postgameMenuInfo.item_again.generic_mc.type		= MTYPE_BITMAP;
	postgameMenuInfo.item_again.generic_mc.name		= ART_REPLAY0;
	postgameMenuInfo.item_again.generic_mc.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	postgameMenuInfo.item_again.generic_mc.x			= 320;
	postgameMenuInfo.item_again.generic_mc.y			= 480-64;
	postgameMenuInfo.item_again.generic_mc.callback	= UI_SPPostgameMenu_AgainEvent;
	postgameMenuInfo.item_again.generic_mc.id			= ID_AGAIN;
	...
	postgameMenuInfo.item_next.generic_mc.type			= MTYPE_BITMAP;
	postgameMenuInfo.item_next.generic_mc.name			= ART_NEXT0;
	postgameMenuInfo.item_next.generic_mc.flags		= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_INACTIVE;
	postgameMenuInfo.item_next.generic_mc.x			= 640;
	postgameMenuInfo.item_next.generic_mc.y			= 480-64;
	postgameMenuInfo.item_next.generic_mc.callback		= UI_SPPostgameMenu_NextEvent;
	postgameMenuInfo.item_next.generic_mc.id			= ID_NEXT;
