...
static void UI_DriverInfo_Menu( void )
{
	...
	s_driverinfo.banner.generic_mc.type  = MTYPE_BTEXT;
	s_driverinfo.banner.generic_mc.x	  = 320;
	s_driverinfo.banner.generic_mc.y	  = 16;
	s_driverinfo.banner.string		  = "DRIVER INFO";
	s_driverinfo.banner.color	      = color_white;
	s_driverinfo.banner.style	      = UI_CENTER;

	s_driverinfo.framel.generic_mc.type  = MTYPE_BITMAP;
	s_driverinfo.framel.generic_mc.name  = DRIVERINFO_FRAMEL;
	s_driverinfo.framel.generic_mc.flags = QMF_INACTIVE;
	s_driverinfo.framel.generic_mc.x	  = 0;
	s_driverinfo.framel.generic_mc.y	  = 78;
	s_driverinfo.framel.width  	      = 256;
	s_driverinfo.framel.height  	  = 329;

	s_driverinfo.framer.generic_mc.type  = MTYPE_BITMAP;
	s_driverinfo.framer.generic_mc.name  = DRIVERINFO_FRAMER;
	s_driverinfo.framer.generic_mc.flags = QMF_INACTIVE;
	s_driverinfo.framer.generic_mc.x	  = 376;
	s_driverinfo.framer.generic_mc.y	  = 76;
	s_driverinfo.framer.width  	      = 256;
	s_driverinfo.framer.height  	  = 334;

	s_driverinfo.back.generic_mc.type	   = MTYPE_BITMAP;
	s_driverinfo.back.generic_mc.name     = DRIVERINFO_BACK0;
	s_driverinfo.back.generic_mc.flags    = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_driverinfo.back.generic_mc.callback = DriverInfo_Event;
	s_driverinfo.back.generic_mc.id	   = ID_DRIVERINFOBACK;
	s_driverinfo.back.generic_mc.x		   = 0;
	s_driverinfo.back.generic_mc.y		   = 480-64;
...
static void GraphicsOptions_GetInitialVideo( void )
{
	...
	s_ivo.fullscreen  = (qboolean)s_graphicsoptions.fs.curvalue; // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
	s_ivo.extensions  = (qboolean)s_graphicsoptions.allow_extensions.curvalue; // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
...
static void GraphicsOptions_UpdateMenuItems( void )
{
	if ( s_graphicsoptions.driver.curvalue == 1 )
	{
		...
		s_graphicsoptions.fs.generic_mc.flags |= QMF_GRAYED;
	...
	if ( s_graphicsoptions.fs.curvalue == 0 || s_graphicsoptions.driver.curvalue == 1 )
	{
		...
		s_graphicsoptions.colordepth.generic_mc.flags |= QMF_GRAYED;
	}
	else
	{
		s_graphicsoptions.colordepth.generic_mc.flags &= ~QMF_GRAYED;
	...
	s_graphicsoptions.apply.generic_mc.flags |= QMF_HIDDEN|QMF_INACTIVE;
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.banner.generic_mc.type  = MTYPE_BTEXT;
	s_graphicsoptions.banner.generic_mc.x	   = 320;
	s_graphicsoptions.banner.generic_mc.y	   = 16;
	...
	s_graphicsoptions.framel.generic_mc.type  = MTYPE_BITMAP;
	s_graphicsoptions.framel.generic_mc.name  = GRAPHICSOPTIONS_FRAMEL;
	s_graphicsoptions.framel.generic_mc.flags = QMF_INACTIVE;
	s_graphicsoptions.framel.generic_mc.x	   = 0;
	s_graphicsoptions.framel.generic_mc.y	   = 78;
	s_graphicsoptions.framel.width  	   = 256;
	s_graphicsoptions.framel.height  	   = 329;

	s_graphicsoptions.framer.generic_mc.type  = MTYPE_BITMAP;
	s_graphicsoptions.framer.generic_mc.name  = GRAPHICSOPTIONS_FRAMER;
	s_graphicsoptions.framer.generic_mc.flags = QMF_INACTIVE;
	s_graphicsoptions.framer.generic_mc.x	   = 376;
	s_graphicsoptions.framer.generic_mc.y	   = 76;
	s_graphicsoptions.framer.width  	   = 256;
	s_graphicsoptions.framer.height  	   = 334;

	s_graphicsoptions.graphics.generic_mc.type		= MTYPE_PTEXT;
	s_graphicsoptions.graphics.generic_mc.flags	= QMF_RIGHT_JUSTIFY;
	s_graphicsoptions.graphics.generic_mc.id		= ID_GRAPHICS;
	s_graphicsoptions.graphics.generic_mc.callback	= GraphicsOptions_Event;
	s_graphicsoptions.graphics.generic_mc.x		= 216;
	s_graphicsoptions.graphics.generic_mc.y		= 240 - 2 * PROP_HEIGHT;
	...
	s_graphicsoptions.display.generic_mc.type		= MTYPE_PTEXT;
	s_graphicsoptions.display.generic_mc.flags		= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_graphicsoptions.display.generic_mc.id		= ID_DISPLAY;
	s_graphicsoptions.display.generic_mc.callback	= GraphicsOptions_Event;
	s_graphicsoptions.display.generic_mc.x			= 216;
	s_graphicsoptions.display.generic_mc.y			= 240 - PROP_HEIGHT;
	...
	s_graphicsoptions.sound.generic_mc.type		= MTYPE_PTEXT;
	s_graphicsoptions.sound.generic_mc.flags		= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_graphicsoptions.sound.generic_mc.id			= ID_SOUND;
	s_graphicsoptions.sound.generic_mc.callback	= GraphicsOptions_Event;
	s_graphicsoptions.sound.generic_mc.x			= 216;
	s_graphicsoptions.sound.generic_mc.y			= 240;
	s_graphicsoptions.sound.string				= "SOUND";
	s_graphicsoptions.sound.style				= UI_RIGHT;
	s_graphicsoptions.sound.color				= color_red;

	s_graphicsoptions.network.generic_mc.type		= MTYPE_PTEXT;
	s_graphicsoptions.network.generic_mc.flags		= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_graphicsoptions.network.generic_mc.id		= ID_NETWORK;
	s_graphicsoptions.network.generic_mc.callback	= GraphicsOptions_Event;
	s_graphicsoptions.network.generic_mc.x			= 216;
	s_graphicsoptions.network.generic_mc.y			= 240 + PROP_HEIGHT;
	s_graphicsoptions.network.string			= "NETWORK";
	s_graphicsoptions.network.style				= UI_RIGHT;
	s_graphicsoptions.network.color				= color_red;

	y = 240 - 6 * (BIGCHAR_HEIGHT + 2);
	s_graphicsoptions.list.generic_mc.type     = MTYPE_SPINCONTROL;
	s_graphicsoptions.list.generic_mc.name     = "Graphics Settings:";
	s_graphicsoptions.list.generic_mc.flags    = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.list.generic_mc.x        = 400;
	s_graphicsoptions.list.generic_mc.y        = y;
	s_graphicsoptions.list.generic_mc.callback = GraphicsOptions_Event;
	s_graphicsoptions.list.generic_mc.id       = ID_LIST;
	s_graphicsoptions.list.itemnames        = s_graphics_options_names;
	y += 2 * ( BIGCHAR_HEIGHT + 2 );

	s_graphicsoptions.driver.generic_mc.type  = MTYPE_SPINCONTROL;
	s_graphicsoptions.driver.generic_mc.name  = "GL Driver:";
	s_graphicsoptions.driver.generic_mc.flags = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.driver.generic_mc.x     = 400;
	s_graphicsoptions.driver.generic_mc.y     = y;
	...
	s_graphicsoptions.allow_extensions.generic_mc.type     = MTYPE_SPINCONTROL;
	s_graphicsoptions.allow_extensions.generic_mc.name	    = "GL Extensions:";
	s_graphicsoptions.allow_extensions.generic_mc.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.allow_extensions.generic_mc.x	    = 400;
	s_graphicsoptions.allow_extensions.generic_mc.y	    = y;
	s_graphicsoptions.allow_extensions.itemnames        = enabled_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_mode"
	s_graphicsoptions.mode.generic_mc.type     = MTYPE_SPINCONTROL;
	s_graphicsoptions.mode.generic_mc.name     = "Video Mode:";
	s_graphicsoptions.mode.generic_mc.flags    = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.mode.generic_mc.x        = 400;
	s_graphicsoptions.mode.generic_mc.y        = y;
	s_graphicsoptions.mode.itemnames        = resolutions;
	s_graphicsoptions.mode.generic_mc.callback = GraphicsOptions_Event;
	s_graphicsoptions.mode.generic_mc.id       = ID_MODE;
	y += BIGCHAR_HEIGHT+2;

	// references "r_colorbits"
	s_graphicsoptions.colordepth.generic_mc.type     = MTYPE_SPINCONTROL;
	s_graphicsoptions.colordepth.generic_mc.name     = "Color Depth:";
	s_graphicsoptions.colordepth.generic_mc.flags    = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.colordepth.generic_mc.x        = 400;
	s_graphicsoptions.colordepth.generic_mc.y        = y;
	s_graphicsoptions.colordepth.itemnames        = colordepth_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_fullscreen"
	s_graphicsoptions.fs.generic_mc.type     = MTYPE_SPINCONTROL;
	s_graphicsoptions.fs.generic_mc.name	  = "Fullscreen:";
	s_graphicsoptions.fs.generic_mc.flags	  = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.fs.generic_mc.x	      = 400;
	s_graphicsoptions.fs.generic_mc.y	      = y;
	s_graphicsoptions.fs.itemnames	      = enabled_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_vertexLight"
	s_graphicsoptions.lighting.generic_mc.type  = MTYPE_SPINCONTROL;
	s_graphicsoptions.lighting.generic_mc.name	 = "Lighting:";
	s_graphicsoptions.lighting.generic_mc.flags = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.lighting.generic_mc.x	 = 400;
	s_graphicsoptions.lighting.generic_mc.y	 = y;
	s_graphicsoptions.lighting.itemnames     = lighting_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_lodBias" & "subdivisions"
	s_graphicsoptions.geometry.generic_mc.type  = MTYPE_SPINCONTROL;
	s_graphicsoptions.geometry.generic_mc.name	 = "Geometric Detail:";
	s_graphicsoptions.geometry.generic_mc.flags = QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.geometry.generic_mc.x	 = 400;
	s_graphicsoptions.geometry.generic_mc.y	 = y;
	s_graphicsoptions.geometry.itemnames     = quality_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_picmip"
	s_graphicsoptions.tq.generic_mc.type	= MTYPE_SLIDER;
	s_graphicsoptions.tq.generic_mc.name	= "Texture Detail:";
	s_graphicsoptions.tq.generic_mc.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.tq.generic_mc.x		= 400;
	s_graphicsoptions.tq.generic_mc.y		= y;
	s_graphicsoptions.tq.minvalue       = 0;
	s_graphicsoptions.tq.maxvalue       = 3;
	s_graphicsoptions.tq.generic_mc.callback = GraphicsOptions_TQEvent;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_textureBits"
	s_graphicsoptions.texturebits.generic_mc.type  = MTYPE_SPINCONTROL;
	s_graphicsoptions.texturebits.generic_mc.name	= "Texture Quality:";
	s_graphicsoptions.texturebits.generic_mc.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.texturebits.generic_mc.x	    = 400;
	s_graphicsoptions.texturebits.generic_mc.y	    = y;
	s_graphicsoptions.texturebits.itemnames     = tq_names;
	y += BIGCHAR_HEIGHT+2;

	// references/modifies "r_textureMode"
	s_graphicsoptions.filter.generic_mc.type   = MTYPE_SPINCONTROL;
	s_graphicsoptions.filter.generic_mc.name	= "Texture Filter:";
	s_graphicsoptions.filter.generic_mc.flags	= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	s_graphicsoptions.filter.generic_mc.x	    = 400;
	s_graphicsoptions.filter.generic_mc.y	    = y;
	s_graphicsoptions.filter.itemnames      = filter_names;
	y += 2*BIGCHAR_HEIGHT;

	s_graphicsoptions.driverinfo.generic_mc.type     = MTYPE_PTEXT;
	s_graphicsoptions.driverinfo.generic_mc.flags    = QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_graphicsoptions.driverinfo.generic_mc.callback = GraphicsOptions_Event;
	s_graphicsoptions.driverinfo.generic_mc.id       = ID_DRIVERINFO;
	s_graphicsoptions.driverinfo.generic_mc.x        = 320;
	s_graphicsoptions.driverinfo.generic_mc.y        = y;
	...
	s_graphicsoptions.back.generic_mc.type	    = MTYPE_BITMAP;
	s_graphicsoptions.back.generic_mc.name     = GRAPHICSOPTIONS_BACK0;
	s_graphicsoptions.back.generic_mc.flags    = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	s_graphicsoptions.back.generic_mc.callback = GraphicsOptions_Event;
	s_graphicsoptions.back.generic_mc.id	    = ID_BACK2;
	s_graphicsoptions.back.generic_mc.x		= 0;
	s_graphicsoptions.back.generic_mc.y		= 480-64;
	s_graphicsoptions.back.width  		    = 128;
	s_graphicsoptions.back.height  		    = 64;
	s_graphicsoptions.back.focuspic         = GRAPHICSOPTIONS_BACK1;

	s_graphicsoptions.apply.generic_mc.type     = MTYPE_BITMAP;
	s_graphicsoptions.apply.generic_mc.name     = GRAPHICSOPTIONS_ACCEPT0;
	s_graphicsoptions.apply.generic_mc.flags    = QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_HIDDEN|QMF_INACTIVE;
	s_graphicsoptions.apply.generic_mc.callback = GraphicsOptions_ApplyChanges;
	s_graphicsoptions.apply.generic_mc.x        = 640;
	s_graphicsoptions.apply.generic_mc.y        = 480-64;
	...
	{
		s_graphicsoptions.driver.generic_mc.flags |= QMF_HIDDEN|QMF_INACTIVE;
	}
}
