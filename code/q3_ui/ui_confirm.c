...
void UI_ConfirmMenu_Style( const char *question, int style, void (*draw)( void ), void (*action)( qboolean result ) ) {
	...
	s_confirm.yes.generic_mc.type		= MTYPE_PTEXT;      
	s_confirm.yes.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS; 
	s_confirm.yes.generic_mc.callback	= ConfirmMenu_Event;
	s_confirm.yes.generic_mc.id		= ID_CONFIRM_YES;
	s_confirm.yes.generic_mc.x			= l1;
	s_confirm.yes.generic_mc.y			= 264;
	s_confirm.yes.string			= "YES";
	s_confirm.yes.color				= color_red;
	s_confirm.yes.style				= UI_LEFT;

	s_confirm.no.generic_mc.type		= MTYPE_PTEXT;      
	s_confirm.no.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS; 
	s_confirm.no.generic_mc.callback	= ConfirmMenu_Event;
	s_confirm.no.generic_mc.id			= ID_CONFIRM_NO;
	s_confirm.no.generic_mc.x		    = l3;
	s_confirm.no.generic_mc.y		    = 264;
...
void UI_Message( const char **lines ) {
	...
	s_confirm.yes.generic_mc.id		= ID_CONFIRM_YES;
	s_confirm.yes.generic_mc.x			= l1;
	s_confirm.yes.generic_mc.y			= 280;
