...
static void UI_CDKeyMenu_Init( void ) {
	...
	cdkeyMenuInfo.banner.generic_mc.type				= MTYPE_BTEXT;
	cdkeyMenuInfo.banner.generic_mc.x					= 320;
	cdkeyMenuInfo.banner.generic_mc.y					= 16;
	cdkeyMenuInfo.banner.string						= "CD KEY";
	cdkeyMenuInfo.banner.color						= color_white;
	cdkeyMenuInfo.banner.style						= UI_CENTER;

	cdkeyMenuInfo.frame.generic_mc.type				= MTYPE_BITMAP;
	cdkeyMenuInfo.frame.generic_mc.name				= ART_FRAME;
	cdkeyMenuInfo.frame.generic_mc.flags				= QMF_INACTIVE;
	cdkeyMenuInfo.frame.generic_mc.x					= 142;
	cdkeyMenuInfo.frame.generic_mc.y					= 118;
	cdkeyMenuInfo.frame.width  						= 359;
	cdkeyMenuInfo.frame.height  					= 256;

	cdkeyMenuInfo.cdkey.generic_mc.type				= MTYPE_FIELD;
	cdkeyMenuInfo.cdkey.generic_mc.name				= "CD Key:";
	cdkeyMenuInfo.cdkey.generic_mc.flags				= QMF_LOWERCASE;
	cdkeyMenuInfo.cdkey.generic_mc.x					= 320 - BIGCHAR_WIDTH * 2.5;
	cdkeyMenuInfo.cdkey.generic_mc.y					= 240 - BIGCHAR_HEIGHT / 2;
	cdkeyMenuInfo.cdkey.field.widthInChars			= 16;
	cdkeyMenuInfo.cdkey.field.maxchars				= 16;
	cdkeyMenuInfo.cdkey.generic_mc.ownerdraw			= UI_CDKeyMenu_DrawKey;

	cdkeyMenuInfo.accept.generic_mc.type				= MTYPE_BITMAP;
	cdkeyMenuInfo.accept.generic_mc.name				= ART_ACCEPT0;
	cdkeyMenuInfo.accept.generic_mc.flags				= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	cdkeyMenuInfo.accept.generic_mc.id					= ID_ACCEPT;
	cdkeyMenuInfo.accept.generic_mc.callback			= UI_CDKeyMenu_Event;
	cdkeyMenuInfo.accept.generic_mc.x					= 640;
	cdkeyMenuInfo.accept.generic_mc.y					= 480-64;
	cdkeyMenuInfo.accept.width						= 128;
	cdkeyMenuInfo.accept.height						= 64;
	cdkeyMenuInfo.accept.focuspic					= ART_ACCEPT1;

	cdkeyMenuInfo.back.generic_mc.type					= MTYPE_BITMAP;
	cdkeyMenuInfo.back.generic_mc.name					= ART_BACK0;
	cdkeyMenuInfo.back.generic_mc.flags				= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	cdkeyMenuInfo.back.generic_mc.id					= ID_BACK;
	cdkeyMenuInfo.back.generic_mc.callback				= UI_CDKeyMenu_Event;
	cdkeyMenuInfo.back.generic_mc.x					= 0;
	cdkeyMenuInfo.back.generic_mc.y					= 480-64;
