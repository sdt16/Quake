...
typedef struct {
	...
	menubitmap_s	delete_mb; // ***GREGS_VC9_PORT_MOD*** -- member name was "delete" which is a keyword in C++, so I changed it to "delete_mb""
	menubitmap_s	back;
...
static void UI_RemoveBotsMenu_Init( void ) {
	...
	removeBotsMenuInfo.banner.generic_mc.type		= MTYPE_BTEXT;
	removeBotsMenuInfo.banner.generic_mc.x			= 320;
	removeBotsMenuInfo.banner.generic_mc.y			= 16;
	...
	removeBotsMenuInfo.background.generic_mc.type	= MTYPE_BITMAP;
	removeBotsMenuInfo.background.generic_mc.name	= ART_BACKGROUND;
	removeBotsMenuInfo.background.generic_mc.flags	= QMF_INACTIVE;
	removeBotsMenuInfo.background.generic_mc.x		= 320-233;
	removeBotsMenuInfo.background.generic_mc.y		= 240-166;
	removeBotsMenuInfo.background.width			= 466;
	removeBotsMenuInfo.background.height		= 332;

	removeBotsMenuInfo.arrows.generic_mc.type		= MTYPE_BITMAP;
	removeBotsMenuInfo.arrows.generic_mc.name		= ART_ARROWS;
	removeBotsMenuInfo.arrows.generic_mc.flags		= QMF_INACTIVE;
	removeBotsMenuInfo.arrows.generic_mc.x			= 200;
	removeBotsMenuInfo.arrows.generic_mc.y			= 128;
	removeBotsMenuInfo.arrows.width				= 64;
	removeBotsMenuInfo.arrows.height			= 128;

	removeBotsMenuInfo.up.generic_mc.type			= MTYPE_BITMAP;
	removeBotsMenuInfo.up.generic_mc.flags			= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	removeBotsMenuInfo.up.generic_mc.x				= 200;
	removeBotsMenuInfo.up.generic_mc.y				= 128;
	removeBotsMenuInfo.up.generic_mc.id			= ID_UP;
	removeBotsMenuInfo.up.generic_mc.callback		= UI_RemoveBotsMenu_UpEvent;
	removeBotsMenuInfo.up.width					= 64;
	removeBotsMenuInfo.up.height				= 64;
	removeBotsMenuInfo.up.focuspic				= ART_ARROWUP;

	removeBotsMenuInfo.down.generic_mc.type		= MTYPE_BITMAP;
	removeBotsMenuInfo.down.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	removeBotsMenuInfo.down.generic_mc.x			= 200;
	removeBotsMenuInfo.down.generic_mc.y			= 128+64;
	removeBotsMenuInfo.down.generic_mc.id			= ID_DOWN;
	removeBotsMenuInfo.down.generic_mc.callback	= UI_RemoveBotsMenu_DownEvent;
	...
	for( n = 0, y = 120; n < count; n++, y += 20 ) {
		removeBotsMenuInfo.bots[n].generic_mc.type		= MTYPE_PTEXT;
		removeBotsMenuInfo.bots[n].generic_mc.flags	= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
		removeBotsMenuInfo.bots[n].generic_mc.id		= ID_BOTNAME0 + n;
		removeBotsMenuInfo.bots[n].generic_mc.x		= 320 - 56;
		removeBotsMenuInfo.bots[n].generic_mc.y		= y;
		removeBotsMenuInfo.bots[n].generic_mc.callback	= UI_RemoveBotsMenu_BotEvent;
	...
	removeBotsMenuInfo.delete_mb.generic_mc.type		= MTYPE_BITMAP; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.name		= ART_DELETE0; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.id		= ID_DELETE; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.callback	= UI_RemoveBotsMenu_DeleteEvent; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.x			= 320+128-128; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.generic_mc.y			= 256+128-64; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.width  			= 128; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.height  			= 64; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
	removeBotsMenuInfo.delete_mb.focuspic			= ART_DELETE1; // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"

	removeBotsMenuInfo.back.generic_mc.type		= MTYPE_BITMAP;
	removeBotsMenuInfo.back.generic_mc.name		= ART_BACK0;
	removeBotsMenuInfo.back.generic_mc.flags		= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
	removeBotsMenuInfo.back.generic_mc.id			= ID_BACK;
	removeBotsMenuInfo.back.generic_mc.callback	= UI_RemoveBotsMenu_BackEvent;
	removeBotsMenuInfo.back.generic_mc.x			= 320-128;
	removeBotsMenuInfo.back.generic_mc.y			= 256+128-64;
	...
	Menu_AddItem( &removeBotsMenuInfo.menu, &removeBotsMenuInfo.delete_mb ); // ***GREGS_VC9_PORT_MOD*** -- changed ".delete" to ".delete_mb"
