...
void SND_setup() {
	...
	buffer = (sndBuffer *)malloc(scs*sizeof(sndBuffer) ); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
	// allocate the stack based hunk allocator
	//Hunk_Alloc(SND_CHUNK_SIZE * sizeof(short) * 4);
	sfxScratchBuffer = (short *)malloc(SND_CHUNK_SIZE * sizeof(short) * 4);	 // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
...
qboolean S_LoadSound( sfx_t *sfx )
{
	...
	samples = (short *)Hunk_AllocateTempMemory(info.samples * sizeof(short) * 2); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
