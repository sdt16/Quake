...
model_t *R_AllocModel( void ) {
	...
	mod = (model_t *)ri.Hunk_Alloc( sizeof( *tr.models[tr.numModels] ), h_low ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
...
static qboolean R_LoadMD3 (model_t *mod, int lod, void *buffer, const char *mod_name ) {
	...
	mod->dataSize += size;
	mod->md3[lod] = (md3Header_t *)ri.Hunk_Alloc( size, h_low ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
...
static qboolean R_LoadMD4( model_t *mod, void *buffer, const char *mod_name ) {
	...
	size = LittleLong(pinmodel->ofsEnd);
	mod->dataSize += size;
	md4 = mod->md4 = (md4Header_t *)ri.Hunk_Alloc( size, h_low ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
