...
qboolean QGL_Init( const char *dllname )
{
	...
	qglAccum                     = dllAccum = (void (__stdcall *)(GLenum,GLfloat))GPA( "glAccum" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglAlphaFunc                 = dllAlphaFunc = (void (__stdcall *)(GLenum,GLclampf))GPA( "glAlphaFunc" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglAreTexturesResident       = dllAreTexturesResident = (GLboolean (__stdcall *)(GLsizei,const GLuint *,GLboolean *))GPA( "glAreTexturesResident" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglArrayElement              = dllArrayElement = (void (__stdcall *)(GLint))GPA( "glArrayElement" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglBegin                     = dllBegin = (void (__stdcall *)(GLenum))GPA( "glBegin" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglBindTexture               = dllBindTexture = (void (__stdcall *)(GLenum,GLuint))GPA( "glBindTexture" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglBitmap                    = dllBitmap = (void (__stdcall *)(GLsizei,GLsizei,GLfloat,GLfloat,GLfloat,GLfloat,const GLubyte *))GPA( "glBitmap" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglBlendFunc                 = dllBlendFunc = (void (__stdcall *)(GLenum,GLenum))GPA( "glBlendFunc" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCallList                  = dllCallList = (void (__stdcall *)(GLuint))GPA( "glCallList" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCallLists                 = dllCallLists = (void (__stdcall *)(GLsizei,GLenum,const GLvoid *))GPA( "glCallLists" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClear                     = dllClear = (void (__stdcall *)(GLbitfield))GPA( "glClear" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClearAccum                = dllClearAccum = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glClearAccum" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClearColor                = dllClearColor = (void (__stdcall *)(GLclampf,GLclampf,GLclampf,GLclampf))GPA( "glClearColor" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClearDepth                = dllClearDepth = (void (__stdcall *)(GLclampd))GPA( "glClearDepth" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClearIndex                = dllClearIndex = (void (__stdcall *)(GLfloat))GPA( "glClearIndex" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClearStencil              = dllClearStencil = (void (__stdcall *)(GLint))GPA( "glClearStencil" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglClipPlane                 = dllClipPlane = (void (__stdcall *)(GLenum,const GLdouble *))GPA( "glClipPlane" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3b                   = dllColor3b = (void (__stdcall *)(GLbyte,GLbyte,GLbyte))GPA( "glColor3b" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3bv                  = dllColor3bv = (void (__stdcall *)(const GLbyte *))GPA( "glColor3bv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3d                   = dllColor3d = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glColor3d" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3dv                  = dllColor3dv = (void (__stdcall *)(const GLdouble *))GPA( "glColor3dv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3f                   = dllColor3f = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glColor3f" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3fv                  = dllColor3fv = (void (__stdcall *)(const GLfloat *))GPA( "glColor3fv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3i                   = dllColor3i = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glColor3i" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3iv                  = dllColor3iv = (void (__stdcall *)(const GLint *))GPA( "glColor3iv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3s                   = dllColor3s = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glColor3s" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3sv                  = dllColor3sv = (void (__stdcall *)(const GLshort *))GPA( "glColor3sv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3ub                  = dllColor3ub = (void (__stdcall *)(GLubyte,GLubyte,GLubyte))GPA( "glColor3ub" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3ubv                 = dllColor3ubv = (void (__stdcall *)(const GLubyte *))GPA( "glColor3ubv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3ui                  = dllColor3ui = (void (__stdcall *)(GLuint,GLuint,GLuint))GPA( "glColor3ui" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3uiv                 = dllColor3uiv = (void (__stdcall *)(const GLuint *))GPA( "glColor3uiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3us                  = dllColor3us = (void (__stdcall *)(GLushort,GLushort,GLushort))GPA( "glColor3us" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor3usv                 = dllColor3usv = (void (__stdcall *)(const GLushort *))GPA( "glColor3usv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4b                   = dllColor4b = (void (__stdcall *)(GLbyte,GLbyte,GLbyte,GLbyte))GPA( "glColor4b" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4bv                  = dllColor4bv = (void (__stdcall *)(const GLbyte *))GPA( "glColor4bv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4d                   = dllColor4d = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glColor4d" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4dv                  = dllColor4dv = (void (__stdcall *)(const GLdouble *))GPA( "glColor4dv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4f                   = dllColor4f = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glColor4f" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4fv                  = dllColor4fv = (void (__stdcall *)(const GLfloat *))GPA( "glColor4fv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4i                   = dllColor4i = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glColor4i" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4iv                  = dllColor4iv = (void (__stdcall *)(const GLint *))GPA( "glColor4iv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4s                   = dllColor4s = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glColor4s" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4sv                  = dllColor4sv = (void (__stdcall *)(const GLshort *))GPA( "glColor4sv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4ub                  = dllColor4ub = (void (__stdcall *)(GLubyte,GLubyte,GLubyte,GLubyte))GPA( "glColor4ub" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4ubv                 = dllColor4ubv = (void (__stdcall *)(const GLubyte *))GPA( "glColor4ubv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4ui                  = dllColor4ui = (void (__stdcall *)(GLuint,GLuint,GLuint,GLuint))GPA( "glColor4ui" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4uiv                 = dllColor4uiv = (void (__stdcall *)(const GLuint *))GPA( "glColor4uiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4us                  = dllColor4us = (void (__stdcall *)(GLushort,GLushort,GLushort,GLushort))GPA( "glColor4us" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColor4usv                 = dllColor4usv = (void (__stdcall *)(const GLushort *))GPA( "glColor4usv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColorMask                 = dllColorMask = (void (__stdcall *)(GLboolean,GLboolean,GLboolean,GLboolean))GPA( "glColorMask" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColorMaterial             = dllColorMaterial = (void (__stdcall *)(GLenum,GLenum))GPA( "glColorMaterial" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglColorPointer              = dllColorPointer = (void (__stdcall *)(GLint,GLenum,GLsizei,const GLvoid *))GPA( "glColorPointer" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCopyPixels                = dllCopyPixels = (void (__stdcall *)(GLint,GLint,GLsizei,GLsizei,GLenum))GPA( "glCopyPixels" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCopyTexImage1D            = dllCopyTexImage1D = (void (__stdcall *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLint))GPA( "glCopyTexImage1D" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCopyTexImage2D            = dllCopyTexImage2D = (void (__stdcall *)(GLenum,GLint,GLenum,GLint,GLint,GLsizei,GLsizei,GLint))GPA( "glCopyTexImage2D" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint,GLsizei))GPA( "glCopyTexSubImage1D" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint,GLint,GLsizei,GLsizei))GPA( "glCopyTexSubImage2D" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglCullFace                  = dllCullFace = (void (__stdcall *)(GLenum))GPA( "glCullFace" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDeleteLists               = dllDeleteLists = (void (__stdcall *)(GLuint,GLsizei))GPA( "glDeleteLists" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDeleteTextures            = dllDeleteTextures = (void (__stdcall *)(GLsizei,const GLuint *))GPA( "glDeleteTextures" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDepthFunc                 = dllDepthFunc = (void (__stdcall *)(GLenum))GPA( "glDepthFunc" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDepthMask                 = dllDepthMask = (void (__stdcall *)(GLboolean))GPA( "glDepthMask" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDepthRange                = dllDepthRange = (void (__stdcall *)(GLclampd,GLclampd))GPA( "glDepthRange" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDisable                   = dllDisable = (void (__stdcall *)(GLenum))GPA( "glDisable" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDisableClientState        = dllDisableClientState = (void (__stdcall *)(GLenum))GPA( "glDisableClientState" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDrawArrays                = dllDrawArrays = (void (__stdcall *)(GLenum,GLint,GLsizei))GPA( "glDrawArrays" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDrawBuffer                = dllDrawBuffer = (void (__stdcall *)(GLenum))GPA( "glDrawBuffer" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDrawElements              = dllDrawElements = (void (__stdcall *)(GLenum,GLsizei,GLenum,const GLvoid *))GPA( "glDrawElements" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglDrawPixels                = dllDrawPixels = (void (__stdcall *)(GLsizei,GLsizei,GLenum,GLenum,const GLvoid *))GPA( "glDrawPixels" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEdgeFlag                  = dllEdgeFlag = (void (__stdcall *)(GLboolean))GPA( "glEdgeFlag" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEdgeFlagPointer           = dllEdgeFlagPointer = (void (__stdcall *)(GLsizei,const GLvoid *))GPA( "glEdgeFlagPointer" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEdgeFlagv                 = dllEdgeFlagv = (void (__stdcall *)(const GLboolean *))GPA( "glEdgeFlagv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEnable                    = 	dllEnable                    = (void (__stdcall *)(GLenum))GPA( "glEnable" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEnableClientState         = 	dllEnableClientState         = (void (__stdcall *)(GLenum))GPA( "glEnableClientState" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEnd                       = 	dllEnd                       = (void (__stdcall *)(void))GPA( "glEnd" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEndList                   = 	dllEndList                   = (void (__stdcall *)(void))GPA( "glEndList" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord1d				 = 	dllEvalCoord1d				 = (void (__stdcall *)(GLdouble))GPA( "glEvalCoord1d" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord1dv              = 	dllEvalCoord1dv              = (void (__stdcall *)(const GLdouble *))GPA( "glEvalCoord1dv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord1f               = 	dllEvalCoord1f               = (void (__stdcall *)(GLfloat))GPA( "glEvalCoord1f" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord1fv              = 	dllEvalCoord1fv              = (void (__stdcall *)(const GLfloat *))GPA( "glEvalCoord1fv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord2d               = 	dllEvalCoord2d               = (void (__stdcall *)(GLdouble,GLdouble))GPA( "glEvalCoord2d" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord2dv              = 	dllEvalCoord2dv              = (void (__stdcall *)(const GLdouble *))GPA( "glEvalCoord2dv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord2f               = 	dllEvalCoord2f               = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glEvalCoord2f" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalCoord2fv              = 	dllEvalCoord2fv              = (void (__stdcall *)(const GLfloat *))GPA( "glEvalCoord2fv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalMesh1                 = 	dllEvalMesh1                 = (void (__stdcall *)(GLenum,GLint,GLint))GPA( "glEvalMesh1" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalMesh2                 = 	dllEvalMesh2                 = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLint))GPA( "glEvalMesh2" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalPoint1                = 	dllEvalPoint1                = (void (__stdcall *)(GLint))GPA( "glEvalPoint1" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglEvalPoint2                = 	dllEvalPoint2                = (void (__stdcall *)(GLint,GLint))GPA( "glEvalPoint2" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFeedbackBuffer            = 	dllFeedbackBuffer            = (void (__stdcall *)(GLsizei,GLenum,GLfloat *))GPA( "glFeedbackBuffer" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFinish                    = 	dllFinish                    = (void (__stdcall *)(void))GPA( "glFinish" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFlush                     = 	dllFlush                     = (void (__stdcall *)(void))GPA( "glFlush" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFogf                      = 	dllFogf                      = (void (__stdcall *)(GLenum,GLfloat))GPA( "glFogf" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFogfv                     = 	dllFogfv                     = (void (__stdcall *)(GLenum,const GLfloat *))GPA( "glFogfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFogi                      = 	dllFogi                      = (void (__stdcall *)(GLenum,GLint))GPA( "glFogi" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFogiv                     = 	dllFogiv                     = (void (__stdcall *)(GLenum,const GLint *))GPA( "glFogiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFrontFace                 = 	dllFrontFace                 = (void (__stdcall *)(GLenum))GPA( "glFrontFace" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglFrustum                   = 	dllFrustum                   = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glFrustum" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGenLists                  = 	dllGenLists                  = ( GLuint (__stdcall * )(int) ) GPA( "glGenLists" );
	qglGenTextures               = 	dllGenTextures               = (void (__stdcall *)(GLsizei,GLuint *))GPA( "glGenTextures" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetBooleanv               = 	dllGetBooleanv               = (void (__stdcall *)(GLenum,GLboolean *))GPA( "glGetBooleanv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetClipPlane              = 	dllGetClipPlane              = (void (__stdcall *)(GLenum,GLdouble *))GPA( "glGetClipPlane" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetDoublev                = 	dllGetDoublev                = (void (__stdcall *)(GLenum,GLdouble *))GPA( "glGetDoublev" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetError                  = 	dllGetError                  = ( GLenum (__stdcall * )(void) ) GPA( "glGetError" );
	qglGetFloatv                 = 	dllGetFloatv                 = (void (__stdcall *)(GLenum,GLfloat *))GPA( "glGetFloatv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetIntegerv               = 	dllGetIntegerv               = (void (__stdcall *)(GLenum,GLint *))GPA( "glGetIntegerv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetLightfv                = 	dllGetLightfv                = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetLightfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetLightiv                = 	dllGetLightiv                = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetLightiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetMapdv                  = 	dllGetMapdv                  = (void (__stdcall *)(GLenum,GLenum,GLdouble *))GPA( "glGetMapdv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetMapfv                  = 	dllGetMapfv                  = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetMapfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetMapiv                  = 	dllGetMapiv                  = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetMapiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetMaterialfv             = 	dllGetMaterialfv             = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetMaterialfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetMaterialiv             = 	dllGetMaterialiv             = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetMaterialiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetPixelMapfv             = 	dllGetPixelMapfv             = (void (__stdcall *)(GLenum,GLfloat *))GPA( "glGetPixelMapfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetPixelMapuiv            = 	dllGetPixelMapuiv            = (void (__stdcall *)(GLenum,GLuint *))GPA( "glGetPixelMapuiv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetPixelMapusv            = 	dllGetPixelMapusv            = (void (__stdcall *)(GLenum,GLushort *))GPA( "glGetPixelMapusv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetPointerv               = 	dllGetPointerv               = (void (__stdcall *)(GLenum,GLvoid **))GPA( "glGetPointerv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetPolygonStipple         = 	dllGetPolygonStipple         = (void (__stdcall *)(GLubyte *))GPA( "glGetPolygonStipple" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetString                 = 	dllGetString                 = (const GLubyte *(__stdcall *)(GLenum))GPA( "glGetString" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexEnvfv               = 	dllGetTexEnvfv               = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexEnvfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexEnviv               = 	dllGetTexEnviv               = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexEnviv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexGendv               = 	dllGetTexGendv               = (void (__stdcall *)(GLenum,GLenum,GLdouble *))GPA( "glGetTexGendv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexGenfv               = 	dllGetTexGenfv               = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexGenfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexGeniv               = 	dllGetTexGeniv               = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexGeniv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexImage               = 	dllGetTexImage               = (void (__stdcall *)(GLenum,GLint,GLenum,GLenum,GLvoid *))GPA( "glGetTexImage" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexParameterfv         = 	dllGetTexParameterfv         = (void (__stdcall *)(GLenum,GLenum,GLfloat *))GPA( "glGetTexParameterfv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglGetTexParameteriv         = 	dllGetTexParameteriv         = (void (__stdcall *)(GLenum,GLenum,GLint *))GPA( "glGetTexParameteriv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglHint                      = 	dllHint                      = (void (__stdcall *)(GLenum,GLenum))GPA( "glHint" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexMask                 = 	dllIndexMask                 = (void (__stdcall *)(GLuint))GPA( "glIndexMask" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexPointer              = 	dllIndexPointer              = (void (__stdcall *)(GLenum,GLsizei,const GLvoid *))GPA( "glIndexPointer" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexd                    = 	dllIndexd                    = (void (__stdcall *)(GLdouble))GPA( "glIndexd" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexdv                   = 	dllIndexdv                   = (void (__stdcall *)(const GLdouble *))GPA( "glIndexdv" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexf                    = 	dllIndexf                    = (void (__stdcall *)(GLfloat))GPA( "glIndexf" ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	qglIndexfv                   = 	dllIndexfv                   = (void (__stdcall *)(const GLfloat *))GPA( "glIndexfv" );
	qglIndexi                    = 	dllIndexi                    = (void (__stdcall *)(GLint))GPA( "glIndexi" );
	qglIndexiv                   = 	dllIndexiv                   = (void (__stdcall *)(const GLint *))GPA( "glIndexiv" );
	qglIndexs                    = 	dllIndexs                    = (void (__stdcall *)(GLshort))GPA( "glIndexs" );
	qglIndexsv                   = 	dllIndexsv                   = (void (__stdcall *)(const GLshort *))GPA( "glIndexsv" );
	qglIndexub                   = 	dllIndexub                   = (void (__stdcall *)(GLubyte))GPA( "glIndexub" );
	qglIndexubv                  = 	dllIndexubv                  = (void (__stdcall *)(const GLubyte *))GPA( "glIndexubv" );
	qglInitNames                 = 	dllInitNames                 = (void (__stdcall *)(void))GPA( "glInitNames" );
	qglInterleavedArrays         = 	dllInterleavedArrays         = (void (__stdcall *)(GLenum,GLsizei,const GLvoid *))GPA( "glInterleavedArrays" );
	qglIsEnabled                 = 	dllIsEnabled                 = (GLboolean (__stdcall *)(GLenum))GPA( "glIsEnabled" );
	qglIsList                    = 	dllIsList                    = (GLboolean (__stdcall *)(GLuint))GPA( "glIsList" );
	qglIsTexture                 = 	dllIsTexture                 = (GLboolean (__stdcall *)(GLuint))GPA( "glIsTexture" );
	qglLightModelf               = 	dllLightModelf               = (void (__stdcall *)(GLenum,GLfloat))GPA( "glLightModelf" );
	qglLightModelfv              = 	dllLightModelfv              = (void (__stdcall *)(GLenum,const GLfloat *))GPA( "glLightModelfv" );
	qglLightModeli               = 	dllLightModeli               = (void (__stdcall *)(GLenum,GLint))GPA( "glLightModeli" );
	qglLightModeliv              = 	dllLightModeliv              = (void (__stdcall *)(GLenum,const GLint *))GPA( "glLightModeliv" );
	qglLightf                    = 	dllLightf                    = (void (__stdcall *)(GLenum,GLenum,GLfloat))GPA( "glLightf" );
	qglLightfv                   = 	dllLightfv                   = (void (__stdcall *)(GLenum,GLenum,const GLfloat *))GPA( "glLightfv" );
	qglLighti                    = 	dllLighti                    = (void (__stdcall *)(GLenum,GLenum,GLint))GPA( "glLighti" );
	qglLightiv                   = 	dllLightiv                   = (void (__stdcall *)(GLenum,GLenum,const GLint *))GPA( "glLightiv" );
	qglLineStipple               = 	dllLineStipple               = (void (__stdcall *)(GLint,GLushort))GPA( "glLineStipple" );
	qglLineWidth                 = 	dllLineWidth                 = (void (__stdcall *)(GLfloat))GPA( "glLineWidth" );
	qglListBase                  = 	dllListBase                  = (void (__stdcall *)(GLuint))GPA( "glListBase" );
	qglLoadIdentity              = 	dllLoadIdentity              = (void (__stdcall *)(void))GPA( "glLoadIdentity" );
	qglLoadMatrixd               = 	dllLoadMatrixd               = (void (__stdcall *)(const GLdouble *))GPA( "glLoadMatrixd" );
	qglLoadMatrixf               = 	dllLoadMatrixf               = (void (__stdcall *)(const GLfloat *))GPA( "glLoadMatrixf" );
	qglLoadName                  = 	dllLoadName                  = (void (__stdcall *)(GLuint))GPA( "glLoadName" );
	qglLogicOp                   = 	dllLogicOp                   = (void (__stdcall *)(GLenum))GPA( "glLogicOp" );
	qglMap1d                     = 	dllMap1d                     = (void (__stdcall *)(GLenum,GLdouble,GLdouble,GLint,GLint,const GLdouble *))GPA( "glMap1d" );
	qglMap1f                     = 	dllMap1f                     = (void (__stdcall *)(GLenum,GLfloat,GLfloat,GLint,GLint,const GLfloat *))GPA( "glMap1f" );
	qglMap2d                     = 	dllMap2d                     = (void (__stdcall *)(GLenum,GLdouble,GLdouble,GLint,GLint,GLdouble,GLdouble,GLint,GLint,const GLdouble *))GPA( "glMap2d" );
	qglMap2f                     = 	dllMap2f                     = (void (__stdcall *)(GLenum,GLfloat,GLfloat,GLint,GLint,GLfloat,GLfloat,GLint,GLint,const GLfloat *))GPA( "glMap2f" );
	qglMapGrid1d                 = 	dllMapGrid1d                 = (void (__stdcall *)(GLint,GLdouble,GLdouble))GPA( "glMapGrid1d" );
	qglMapGrid1f                 = 	dllMapGrid1f                 = (void (__stdcall *)(GLint,GLfloat,GLfloat))GPA( "glMapGrid1f" );
	qglMapGrid2d                 = 	dllMapGrid2d                 = (void (__stdcall *)(GLint,GLdouble,GLdouble,GLint,GLdouble,GLdouble))GPA( "glMapGrid2d" );
	qglMapGrid2f                 = 	dllMapGrid2f                 = (void (__stdcall *)(GLint,GLfloat,GLfloat,GLint,GLfloat,GLfloat))GPA( "glMapGrid2f" );
	qglMaterialf                 = 	dllMaterialf                 = (void (__stdcall *)(GLenum,GLenum,GLfloat))GPA( "glMaterialf" );
	qglMaterialfv                = 	dllMaterialfv                = (void (__stdcall *)(GLenum,GLenum,const GLfloat *))GPA( "glMaterialfv" );
	qglMateriali                 = 	dllMateriali                 = (void (__stdcall *)(GLenum,GLenum,GLint))GPA( "glMateriali" );
	qglMaterialiv                = 	dllMaterialiv                = (void (__stdcall *)(GLenum,GLenum,const GLint *))GPA( "glMaterialiv" );
	qglMatrixMode                = 	dllMatrixMode                = (void (__stdcall *)(GLenum))GPA( "glMatrixMode" );
	qglMultMatrixd               = 	dllMultMatrixd               = (void (__stdcall *)(const GLdouble *))GPA( "glMultMatrixd" );
	qglMultMatrixf               = 	dllMultMatrixf               = (void (__stdcall *)(const GLfloat *))GPA( "glMultMatrixf" );
	qglNewList                   = 	dllNewList                   = (void (__stdcall *)(GLuint,GLenum))GPA( "glNewList" );
	qglNormal3b                  = 	dllNormal3b                  = (void (__stdcall *)(GLbyte,GLbyte,GLbyte))GPA( "glNormal3b" );
	qglNormal3bv                 = 	dllNormal3bv                 = (void (__stdcall *)(const GLbyte *))GPA( "glNormal3bv" );
	qglNormal3d                  = 	dllNormal3d                  = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glNormal3d" );
	qglNormal3dv                 = 	dllNormal3dv                 = (void (__stdcall *)(const GLdouble *))GPA( "glNormal3dv" );
	qglNormal3f                  = 	dllNormal3f                  = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glNormal3f" );
	qglNormal3fv                 = 	dllNormal3fv                 = (void (__stdcall *)(const GLfloat *))GPA( "glNormal3fv" );
	qglNormal3i                  = 	dllNormal3i                  = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glNormal3i" );
	qglNormal3iv                 = 	dllNormal3iv                 = (void (__stdcall *)(const GLint *))GPA( "glNormal3iv" );
	qglNormal3s                  = 	dllNormal3s                  = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glNormal3s" );
	qglNormal3sv                 = 	dllNormal3sv                 = (void (__stdcall *)(const GLshort *))GPA( "glNormal3sv" );
	qglNormalPointer             = 	dllNormalPointer             = (void (__stdcall *)(GLenum,GLsizei,const GLvoid *))GPA( "glNormalPointer" );
	qglOrtho                     = 	dllOrtho                     = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glOrtho" );
	qglPassThrough               = 	dllPassThrough               = (void (__stdcall *)(GLfloat))GPA( "glPassThrough" );
	qglPixelMapfv                = 	dllPixelMapfv                = (void (__stdcall *)(GLenum,GLsizei,const GLfloat *))GPA( "glPixelMapfv" );
	qglPixelMapuiv               = 	dllPixelMapuiv               = (void (__stdcall *)(GLenum,GLsizei,const GLuint *))GPA( "glPixelMapuiv" );
	qglPixelMapusv               = 	dllPixelMapusv               = (void (__stdcall *)(GLenum,GLsizei,const GLushort *))GPA( "glPixelMapusv" );
	qglPixelStoref               = 	dllPixelStoref               = (void (__stdcall *)(GLenum,GLfloat))GPA( "glPixelStoref" );
	qglPixelStorei               = 	dllPixelStorei               = (void (__stdcall *)(GLenum,GLint))GPA( "glPixelStorei" );
	qglPixelTransferf            = 	dllPixelTransferf            = (void (__stdcall *)(GLenum,GLfloat))GPA( "glPixelTransferf" );
	qglPixelTransferi            = 	dllPixelTransferi            = (void (__stdcall *)(GLenum,GLint))GPA( "glPixelTransferi" );
	qglPixelZoom                 = 	dllPixelZoom                 = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glPixelZoom" );
	qglPointSize                 = 	dllPointSize                 = (void (__stdcall *)(GLfloat))GPA( "glPointSize" );
	qglPolygonMode               = 	dllPolygonMode               = (void (__stdcall *)(GLenum,GLenum))GPA( "glPolygonMode" );
	qglPolygonOffset             = 	dllPolygonOffset             = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glPolygonOffset" );
	qglPolygonStipple            = 	dllPolygonStipple            = (void (__stdcall *)(const GLubyte *))GPA( "glPolygonStipple" );
	...
	qglPrioritizeTextures        = 	dllPrioritizeTextures        = (void (__stdcall *)(GLsizei,const GLuint *,const GLclampf *))GPA( "glPrioritizeTextures" );
	qglPushAttrib                = 	dllPushAttrib                = (void (__stdcall *)(GLbitfield))GPA( "glPushAttrib" );
	qglPushClientAttrib          = 	dllPushClientAttrib          = (void (__stdcall *)(GLbitfield))GPA( "glPushClientAttrib" );
	qglPushMatrix                = 	dllPushMatrix                = (void (__stdcall *)(void))GPA( "glPushMatrix" );
	qglPushName                  = 	dllPushName                  = (void (__stdcall *)(GLuint))GPA( "glPushName" );
	qglRasterPos2d               = 	dllRasterPos2d               = (void (__stdcall *)(GLdouble,GLdouble))GPA( "glRasterPos2d" );
	qglRasterPos2dv              = 	dllRasterPos2dv              = (void (__stdcall *)(const GLdouble *))GPA( "glRasterPos2dv" );
	qglRasterPos2f               = 	dllRasterPos2f               = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glRasterPos2f" );
	qglRasterPos2fv              = 	dllRasterPos2fv              = (void (__stdcall *)(const GLfloat *))GPA( "glRasterPos2fv" );
	qglRasterPos2i               = 	dllRasterPos2i               = (void (__stdcall *)(GLint,GLint))GPA( "glRasterPos2i" );
	qglRasterPos2iv              = 	dllRasterPos2iv              = (void (__stdcall *)(const GLint *))GPA( "glRasterPos2iv" );
	qglRasterPos2s               = 	dllRasterPos2s               = (void (__stdcall *)(GLshort,GLshort))GPA( "glRasterPos2s" );
	qglRasterPos2sv              = 	dllRasterPos2sv              = (void (__stdcall *)(const GLshort *))GPA( "glRasterPos2sv" );
	qglRasterPos3d               = 	dllRasterPos3d               = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glRasterPos3d" );
	qglRasterPos3dv              = 	dllRasterPos3dv              = (void (__stdcall *)(const GLdouble *))GPA( "glRasterPos3dv" );
	qglRasterPos3f               = 	dllRasterPos3f               = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glRasterPos3f" );
	qglRasterPos3fv              = 	dllRasterPos3fv              = (void (__stdcall *)(const GLfloat *))GPA( "glRasterPos3fv" );
	qglRasterPos3i               = 	dllRasterPos3i               = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glRasterPos3i" );
	qglRasterPos3iv              = 	dllRasterPos3iv              = (void (__stdcall *)(const GLint *))GPA( "glRasterPos3iv" );
	qglRasterPos3s               = 	dllRasterPos3s               = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glRasterPos3s" );
	qglRasterPos3sv              = 	dllRasterPos3sv              = (void (__stdcall *)(const GLshort *))GPA( "glRasterPos3sv" );
	qglRasterPos4d               = 	dllRasterPos4d               = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glRasterPos4d" );
	qglRasterPos4dv              = 	dllRasterPos4dv              = (void (__stdcall *)(const GLdouble *))GPA( "glRasterPos4dv" );
	qglRasterPos4f               = 	dllRasterPos4f               = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glRasterPos4f" );
	qglRasterPos4fv              = 	dllRasterPos4fv              = (void (__stdcall *)(const GLfloat *))GPA( "glRasterPos4fv" );
	qglRasterPos4i               = 	dllRasterPos4i               = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glRasterPos4i" );
	qglRasterPos4iv              = 	dllRasterPos4iv              = (void (__stdcall *)(const GLint *))GPA( "glRasterPos4iv" );
	qglRasterPos4s               = 	dllRasterPos4s               = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glRasterPos4s" );
	qglRasterPos4sv              = 	dllRasterPos4sv              = (void (__stdcall *)(const GLshort *))GPA( "glRasterPos4sv" );
	qglReadBuffer                = 	dllReadBuffer                = (void (__stdcall *)(GLenum))GPA( "glReadBuffer" );
	qglReadPixels                = 	dllReadPixels                = (void (__stdcall *)(GLint,GLint,GLsizei,GLsizei,GLenum,GLenum,GLvoid *))GPA( "glReadPixels" );
	qglRectd                     = 	dllRectd                     = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glRectd" );
	qglRectdv                    = 	dllRectdv                    = (void (__stdcall *)(const GLdouble *,const GLdouble *))GPA( "glRectdv" );
	qglRectf                     = 	dllRectf                     = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glRectf" );
	qglRectfv                    = 	dllRectfv                    = (void (__stdcall *)(const GLfloat *,const GLfloat *))GPA( "glRectfv" );
	qglRecti                     = 	dllRecti                     = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glRecti" );
	qglRectiv                    = 	dllRectiv                    = (void (__stdcall *)(const GLint *,const GLint *))GPA( "glRectiv" );
	qglRects                     = 	dllRects                     = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glRects" );
	qglRectsv                    = 	dllRectsv                    = (void (__stdcall *)(const GLshort *,const GLshort *))GPA( "glRectsv" );
	qglRenderMode                = 	dllRenderMode                = (GLint (__stdcall *)(GLenum))GPA( "glRenderMode" );
	qglRotated                   = 	dllRotated                   = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glRotated" );
	qglRotatef                   = 	dllRotatef                   = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glRotatef" );
	qglScaled                    = 	dllScaled                    = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glScaled" );
	qglScalef                    = 	dllScalef                    = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glScalef" );
	qglScissor                   = 	dllScissor                   = (void (__stdcall *)(GLint,GLint,GLsizei,GLsizei))GPA( "glScissor" );
	qglSelectBuffer              = 	dllSelectBuffer              = (void (__stdcall *)(GLsizei,GLuint *))GPA( "glSelectBuffer" );
	qglShadeModel                = 	dllShadeModel                = (void (__stdcall *)(GLenum))GPA( "glShadeModel" );
	qglStencilFunc               = 	dllStencilFunc               = (void (__stdcall *)(GLenum,GLint,GLuint))GPA( "glStencilFunc" );
	qglStencilMask               = 	dllStencilMask               = (void (__stdcall *)(GLuint))GPA( "glStencilMask" );
	qglStencilOp                 = 	dllStencilOp                 = (void (__stdcall *)(GLenum,GLenum,GLenum))GPA( "glStencilOp" );
	qglTexCoord1d                = 	dllTexCoord1d                = (void (__stdcall *)(GLdouble))GPA( "glTexCoord1d" );
	qglTexCoord1dv               = 	dllTexCoord1dv               = (void (__stdcall *)(const GLdouble *))GPA( "glTexCoord1dv" );
	qglTexCoord1f                = 	dllTexCoord1f                = (void (__stdcall *)(GLfloat))GPA( "glTexCoord1f" );
	qglTexCoord1fv               = 	dllTexCoord1fv               = (void (__stdcall *)(const GLfloat *))GPA( "glTexCoord1fv" );
	qglTexCoord1i                = 	dllTexCoord1i                = (void (__stdcall *)(GLint))GPA( "glTexCoord1i" );
	qglTexCoord1iv               = 	dllTexCoord1iv               = (void (__stdcall *)(const GLint *))GPA( "glTexCoord1iv" );
	qglTexCoord1s                = 	dllTexCoord1s                = (void (__stdcall *)(GLshort))GPA( "glTexCoord1s" );
	qglTexCoord1sv               = 	dllTexCoord1sv               = (void (__stdcall *)(const GLshort *))GPA( "glTexCoord1sv" );
	qglTexCoord2d                = 	dllTexCoord2d                = (void (__stdcall *)(GLdouble,GLdouble))GPA( "glTexCoord2d" );
	qglTexCoord2dv               = 	dllTexCoord2dv               = (void (__stdcall *)(const GLdouble *))GPA( "glTexCoord2dv" );
	qglTexCoord2f                = 	dllTexCoord2f                = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glTexCoord2f" );
	qglTexCoord2fv               = 	dllTexCoord2fv               = (void (__stdcall *)(const GLfloat *))GPA( "glTexCoord2fv" );
	qglTexCoord2i                = 	dllTexCoord2i                = (void (__stdcall *)(GLint,GLint))GPA( "glTexCoord2i" );
	qglTexCoord2iv               = 	dllTexCoord2iv               = (void (__stdcall *)(const GLint *))GPA( "glTexCoord2iv" );
	qglTexCoord2s                = 	dllTexCoord2s                = (void (__stdcall *)(GLshort,GLshort))GPA( "glTexCoord2s" );
	qglTexCoord2sv               = 	dllTexCoord2sv               = (void (__stdcall *)(const GLshort *))GPA( "glTexCoord2sv" );
	qglTexCoord3d                = 	dllTexCoord3d                = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glTexCoord3d" );
	qglTexCoord3dv               = 	dllTexCoord3dv               = (void (__stdcall *)(const GLdouble *))GPA( "glTexCoord3dv" );
	qglTexCoord3f                = 	dllTexCoord3f                = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glTexCoord3f" );
	qglTexCoord3fv               = 	dllTexCoord3fv               = (void (__stdcall *)(const GLfloat *))GPA( "glTexCoord3fv" );
	qglTexCoord3i                = 	dllTexCoord3i                = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glTexCoord3i" );
	qglTexCoord3iv               = 	dllTexCoord3iv               = (void (__stdcall *)(const GLint *))GPA( "glTexCoord3iv" );
	qglTexCoord3s                = 	dllTexCoord3s                = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glTexCoord3s" );
	qglTexCoord3sv               = 	dllTexCoord3sv               = (void (__stdcall *)(const GLshort *))GPA( "glTexCoord3sv" );
	qglTexCoord4d                = 	dllTexCoord4d                = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glTexCoord4d" );
	qglTexCoord4dv               = 	dllTexCoord4dv               = (void (__stdcall *)(const GLdouble *))GPA( "glTexCoord4dv" );
	qglTexCoord4f                = 	dllTexCoord4f                = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glTexCoord4f" );
	qglTexCoord4fv               = 	dllTexCoord4fv               = (void (__stdcall *)(const GLfloat *))GPA( "glTexCoord4fv" );
	qglTexCoord4i                = 	dllTexCoord4i                = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glTexCoord4i" );
	qglTexCoord4iv               = 	dllTexCoord4iv               = (void (__stdcall *)(const GLint *))GPA( "glTexCoord4iv" );
	qglTexCoord4s                = 	dllTexCoord4s                = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glTexCoord4s" );
	qglTexCoord4sv               = 	dllTexCoord4sv               = (void (__stdcall *)(const GLshort *))GPA( "glTexCoord4sv" );
	qglTexCoordPointer           = 	dllTexCoordPointer           = (void (__stdcall *)(GLint,GLenum,GLsizei,const GLvoid *))GPA( "glTexCoordPointer" );
	qglTexEnvf                   = 	dllTexEnvf                   = (void (__stdcall *)(GLenum,GLenum,GLfloat))GPA( "glTexEnvf" );
	qglTexEnvfv                  = 	dllTexEnvfv                  = (void (__stdcall *)(GLenum,GLenum,const GLfloat *))GPA( "glTexEnvfv" );
	qglTexEnvi                   = 	dllTexEnvi                   = (void (__stdcall *)(GLenum,GLenum,GLint))GPA( "glTexEnvi" );
	qglTexEnviv                  = 	dllTexEnviv                  = (void (__stdcall *)(GLenum,GLenum,const GLint *))GPA( "glTexEnviv" );
	qglTexGend                   = 	dllTexGend                   = (void (__stdcall *)(GLenum,GLenum,GLdouble))GPA( "glTexGend" );
	qglTexGendv                  = 	dllTexGendv                  = (void (__stdcall *)(GLenum,GLenum,const GLdouble *))GPA( "glTexGendv" );
	qglTexGenf                   = 	dllTexGenf                   = (void (__stdcall *)(GLenum,GLenum,GLfloat))GPA( "glTexGenf" );
	qglTexGenfv                  = 	dllTexGenfv                  = (void (__stdcall *)(GLenum,GLenum,const GLfloat *))GPA( "glTexGenfv" );
	qglTexGeni                   = 	dllTexGeni                   = (void (__stdcall *)(GLenum,GLenum,GLint))GPA( "glTexGeni" );
	qglTexGeniv                  = 	dllTexGeniv                  = (void (__stdcall *)(GLenum,GLenum,const GLint *))GPA( "glTexGeniv" );
	qglTexImage1D                = 	dllTexImage1D                = (void (__stdcall *)(GLenum,GLint,GLint,GLsizei,GLint,GLenum,GLenum,const GLvoid *))GPA( "glTexImage1D" );
	qglTexImage2D                = 	dllTexImage2D                = (void (__stdcall *)(GLenum,GLint,GLint,GLsizei,GLsizei,GLint,GLenum,GLenum,const GLvoid *))GPA( "glTexImage2D" );
	qglTexParameterf             = 	dllTexParameterf             = (void (__stdcall *)(GLenum,GLenum,GLfloat))GPA( "glTexParameterf" );
	qglTexParameterfv            = 	dllTexParameterfv            = (void (__stdcall *)(GLenum,GLenum,const GLfloat *))GPA( "glTexParameterfv" );
	qglTexParameteri             = 	dllTexParameteri             = (void (__stdcall *)(GLenum,GLenum,GLint))GPA( "glTexParameteri" );
	qglTexParameteriv            = 	dllTexParameteriv            = (void (__stdcall *)(GLenum,GLenum,const GLint *))GPA( "glTexParameteriv" );
	qglTexSubImage1D             = 	dllTexSubImage1D             = (void (__stdcall *)(GLenum,GLint,GLint,GLsizei,GLenum,GLenum,const GLvoid *))GPA( "glTexSubImage1D" );
	qglTexSubImage2D             = 	dllTexSubImage2D             = (void (__stdcall *)(GLenum,GLint,GLint,GLint,GLsizei,GLsizei,GLenum,GLenum,const GLvoid *))GPA( "glTexSubImage2D" );
	qglTranslated                = 	dllTranslated                = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glTranslated" );
	qglTranslatef                = 	dllTranslatef                = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glTranslatef" );
	qglVertex2d                  = 	dllVertex2d                  = (void (__stdcall *)(GLdouble,GLdouble))GPA( "glVertex2d" );
	qglVertex2dv                 = 	dllVertex2dv                 = (void (__stdcall *)(const GLdouble *))GPA( "glVertex2dv" );
	qglVertex2f                  = 	dllVertex2f                  = (void (__stdcall *)(GLfloat,GLfloat))GPA( "glVertex2f" );
	qglVertex2fv                 = 	dllVertex2fv                 = (void (__stdcall *)(const GLfloat *))GPA( "glVertex2fv" );
	qglVertex2i                  = 	dllVertex2i                  = (void (__stdcall *)(GLint,GLint))GPA( "glVertex2i" );
	qglVertex2iv                 = 	dllVertex2iv                 = (void (__stdcall *)(const GLint *))GPA( "glVertex2iv" );
	qglVertex2s                  = 	dllVertex2s                  = (void (__stdcall *)(GLshort,GLshort))GPA( "glVertex2s" );
	qglVertex2sv                 = 	dllVertex2sv                 = (void (__stdcall *)(const GLshort *))GPA( "glVertex2sv" );
	qglVertex3d                  = 	dllVertex3d                  = (void (__stdcall *)(GLdouble,GLdouble,GLdouble))GPA( "glVertex3d" );
	qglVertex3dv                 = 	dllVertex3dv                 = (void (__stdcall *)(const GLdouble *))GPA( "glVertex3dv" );
	qglVertex3f                  = 	dllVertex3f                  = (void (__stdcall *)(GLfloat,GLfloat,GLfloat))GPA( "glVertex3f" );
	qglVertex3fv                 = 	dllVertex3fv                 = (void (__stdcall *)(const GLfloat *))GPA( "glVertex3fv" );
	qglVertex3i                  = 	dllVertex3i                  = (void (__stdcall *)(GLint,GLint,GLint))GPA( "glVertex3i" );
	qglVertex3iv                 = 	dllVertex3iv                 = (void (__stdcall *)(const GLint *))GPA( "glVertex3iv" );
	qglVertex3s                  = 	dllVertex3s                  = (void (__stdcall *)(GLshort,GLshort,GLshort))GPA( "glVertex3s" );
	qglVertex3sv                 = 	dllVertex3sv                 = (void (__stdcall *)(const GLshort *))GPA( "glVertex3sv" );
	qglVertex4d                  = 	dllVertex4d                  = (void (__stdcall *)(GLdouble,GLdouble,GLdouble,GLdouble))GPA( "glVertex4d" );
	qglVertex4dv                 = 	dllVertex4dv                 = (void (__stdcall *)(const GLdouble *))GPA( "glVertex4dv" );
	qglVertex4f                  = 	dllVertex4f                  = (void (__stdcall *)(GLfloat,GLfloat,GLfloat,GLfloat))GPA( "glVertex4f" );
	qglVertex4fv                 = 	dllVertex4fv                 = (void (__stdcall *)(const GLfloat *))GPA( "glVertex4fv" );
	qglVertex4i                  = 	dllVertex4i                  = (void (__stdcall *)(GLint,GLint,GLint,GLint))GPA( "glVertex4i" );
	qglVertex4iv                 = 	dllVertex4iv                 = (void (__stdcall *)(const GLint *))GPA( "glVertex4iv" );
	qglVertex4s                  = 	dllVertex4s                  = (void (__stdcall *)(GLshort,GLshort,GLshort,GLshort))GPA( "glVertex4s" );
	qglVertex4sv                 = 	dllVertex4sv                 = (void (__stdcall *)(const GLshort *))GPA( "glVertex4sv" );
	qglVertexPointer             = 	dllVertexPointer             = (void (__stdcall *)(GLint,GLenum,GLsizei,const GLvoid *))GPA( "glVertexPointer" );
	qglViewport                  = 	dllViewport                  = (void (__stdcall *)(GLint,GLint,GLsizei,GLsizei))GPA( "glViewport" );

	qwglCopyContext              = (BOOL (__stdcall *)(HGLRC,HGLRC,UINT))GPA( "wglCopyContext" );
	qwglCreateContext            = (HGLRC (__stdcall *)(HDC))GPA( "wglCreateContext" );
	qwglCreateLayerContext       = (HGLRC (__stdcall *)(HDC,int))GPA( "wglCreateLayerContext" );
	qwglDeleteContext            = (BOOL (__stdcall *)(HGLRC))GPA( "wglDeleteContext" );
	qwglDescribeLayerPlane       = (BOOL (__stdcall *)(HDC,int,int,UINT,LPLAYERPLANEDESCRIPTOR))GPA( "wglDescribeLayerPlane" );
	qwglGetCurrentContext        = (HGLRC (__stdcall *)(void))GPA( "wglGetCurrentContext" );
	qwglGetCurrentDC             = (HDC (__stdcall *)(void))GPA( "wglGetCurrentDC" );
	qwglGetLayerPaletteEntries   = (int (__stdcall *)(HDC,int,int,int,COLORREF *))GPA( "wglGetLayerPaletteEntries" );
	qwglGetProcAddress           = (PROC (__stdcall *)(LPCSTR))GPA( "wglGetProcAddress" );
	qwglMakeCurrent              = (BOOL (__stdcall *)(HDC,HGLRC))GPA( "wglMakeCurrent" );
	qwglRealizeLayerPalette      = (BOOL (__stdcall *)(HDC,int,BOOL))GPA( "wglRealizeLayerPalette" );
	qwglSetLayerPaletteEntries   = (int (__stdcall *)(HDC,int,int,int,const COLORREF *))GPA( "wglSetLayerPaletteEntries" );
	qwglShareLists               = (BOOL (__stdcall *)(HGLRC,HGLRC))GPA( "wglShareLists" );
	qwglSwapLayerBuffers         = (BOOL (__stdcall *)(HDC,UINT))GPA( "wglSwapLayerBuffers" );
	qwglUseFontBitmaps           = (BOOL (__stdcall *)(HDC,DWORD,DWORD,DWORD))GPA( "wglUseFontBitmapsA" );
	qwglUseFontOutlines          = (BOOL (__stdcall *)(HDC,DWORD,DWORD,DWORD,FLOAT,FLOAT,int,LPGLYPHMETRICSFLOAT))GPA( "wglUseFontOutlinesA" );

	qwglChoosePixelFormat        = (int (__stdcall *)(HDC,const PIXELFORMATDESCRIPTOR *))GPA( "wglChoosePixelFormat" );
	qwglDescribePixelFormat      = (int (__stdcall *)(HDC,int,UINT,LPPIXELFORMATDESCRIPTOR))GPA( "wglDescribePixelFormat" );
	qwglGetPixelFormat           = (int (__stdcall *)(HDC))GPA( "wglGetPixelFormat" );
	qwglSetPixelFormat           = (BOOL (__stdcall *)(HDC,int,const PIXELFORMATDESCRIPTOR *))GPA( "wglSetPixelFormat" );
	qwglSwapBuffers              = (BOOL (__stdcall *)(HDC))GPA( "wglSwapBuffers" );
	...
	// check logging
	QGL_EnableLogging( (qboolean)r_logFile->integer );  // ***GREGS_VC9_PORT_MOD*** -- needed typecast
