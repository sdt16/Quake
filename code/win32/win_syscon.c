...
//		s_wcd.hbmClearBitmap = LoadBitmap( g_wv.hInstance, MAKEINTRESOURCE( IDB_BITMAP2 ) );
	...
	case WM_TIMER:
		if ( wParam == 1 )
		{
			s_timePolarity = (qboolean)(!s_timePolarity); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
...
void Sys_CreateConsole( void )
{
	...
	wc.hbrBackground = (HBRUSH)COLOR_WINDOW;  // ***GREGS_VC9_PORT_MOD*** -- changed typecast; was void *
	wc.lpszMenuName  = 0;
