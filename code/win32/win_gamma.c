...
void WG_CheckHardwareGamma( void )
{
	...
	if ( qwglSetDeviceGammaRamp3DFX )
	{
		...
		glConfig.deviceSupportsGamma = (qboolean)qwglGetDeviceGammaRamp3DFX( hDC, s_oldHardwareGamma ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
	...
	{
		hDC = GetDC( GetDesktopWindow() );
		glConfig.deviceSupportsGamma = (qboolean)GetDeviceGammaRamp( hDC, s_oldHardwareGamma ); // ***GREGS_VC9_PORT_MOD*** -- needed typecast
		ReleaseDC( GetDesktopWindow(), hDC );
