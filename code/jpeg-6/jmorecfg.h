...
typedef /*long*/ int INT32; // ***GREGS_VC9_PORT_MOD*** -- I hate changing a third-party lib, but unfortunately to make this header file play nice with a C++
                            //                             Windows app under Visual Studio 9.0 we need to make "INT32" typedef to an "int" instead of "long" because
                            //                             there's a core windows header file which also defines "INT32" - causing the compiler to spit out duplicate
                            //                             definition errors; since a "long" and "int" are the exact same thing under the MSVC++ compiler, then this
