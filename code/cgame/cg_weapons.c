...
static float	CG_MachinegunSpinAngle( centity_t *cent ) {
	...
	if ( cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING) ) {
		...
		cent->pe.barrelSpinning = (qboolean)(!!(cent->currentState.eFlags & EF_FIRING)); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
#ifdef MISSIONPACK
...
//	int	col;
	...
	weaponNum = (weapon_t)cent->currentState.weapon; // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
