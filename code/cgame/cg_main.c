...
int vmMain( int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11  ) {
	...
	case CG_DRAW_ACTIVE_FRAME:
		CG_DrawActiveFrame( arg0, (stereoFrame_t)arg1, (qboolean)arg2 ); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
		return 0;
	...
	case CG_KEY_EVENT:
		CG_KeyEvent(arg0, (qboolean)arg1); // ***GREGS_VC9_PORT_MOD*** -- added typecast(s)
		return 0;
	case CG_MOUSE_EVENT:
#ifdef MISSIONPACK
